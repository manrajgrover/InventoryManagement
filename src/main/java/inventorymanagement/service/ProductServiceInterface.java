...
public interface ProductServiceInterface {
   ...
   * 
   * @param productModel {@link IncomingProductModel} Model containing data to add a new product to
   *        database
   ...
   * @param productModel {@link IncomingProductModel} Model containing data to update a product in
   *        database
   * @return {@link ProductModel}
   * @throws BadRequestException Thrown when any of the field is empty
